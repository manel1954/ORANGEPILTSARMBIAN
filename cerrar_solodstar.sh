...
sed -i "6c Exec=xterm -geometry 87x13+1277+830 -bg brown -fg green -fa 'roboto' -fs 9x -T SOLODSTAR -e sh ejecutar_solodstar.sh" /home/orangepi/Desktop/AbrirsoloDstar.desktop
