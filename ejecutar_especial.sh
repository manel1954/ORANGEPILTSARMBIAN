...
sed -i "6c Exec=xterm -geometry 85x13+655+830 -bg black -fg yellow -fa 'roboto' -fs 9x -T ESPECIAL -e sh ejecutar_especial.sh" /home/orangepi/Desktop/Abrir_ESPECIAL.desktop
