...
xterm -geometry 86x13+1277+830 -bg black -fg yellow -fa 'roboto' -fs 9x -T ESPECIAL -e sudo ./MMDVMESPECIAL MMDVMESPECIAL.ini

sudo killall MMDVMESPECIAL
cd /home/orangepi/ORANGEPI
sed -i "10c MMDVMESPECIAL=OFF" /home/orangepi/status.ini

sed -i "6c Exec=xterm -geometry 86x13+1277+830 -bg black -fg yellow -fa 'roboto' -fs 9x -T ESPECIAL -e sh ejecutar_especial.sh" /home/orangepi/Desktop/Abrir_ESPECIAL.desktop
