...
xterm -geometry 86x6+1277+830 -bg brown -fg white -fa 'roboto' -fs 9x -T YSF2DMR -e ./YSF2DMR YSF2DMR.ini & 

cd /home/orangepi/MMDVMHost
xterm -geometry 86x6+1277+987 -bg brown -fg white -fa 'roboto' -fs 9x -T MMDVMFUSION -e ./MMDVMFUSION MMDVMFUSION.ini
