...
sed -i "6c Exec=xterm -geometry 86x13+1277+830 -bg brown -fg green -fa 'roboto' -fs 9x -T YSFGateway -e sh ejecutar_ysf_05.sh" /home/orangepi/Desktop/YSFGateway.desktop
