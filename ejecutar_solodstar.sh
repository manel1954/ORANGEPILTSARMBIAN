...
sed -i "6c Exec=xterm -geometry 85x13+1300+830 -bg brown -fg green -fa 'roboto' -fs 9x -T SOLODSTAR -e sh ejecutar_solodstar.sh" /home/orangepi/Desktop/AbrirsoloDstar.desktop
