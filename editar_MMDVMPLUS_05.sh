...
clear
                  ...
                  indi=$(awk "NR==2" /home/orangepi/MMDVMHost/MMDVMPLUS)
                  sed -i "1c $indi" /home/orangepi/info_panel_control.ini
                  ide=$(awk "NR==3" /home/orangepi/MMDVMHost/MMDVMPLUS)
                  sed -i "2c $ide" /home/orangepi/info_panel_control.ini
                  frec=$(awk "NR==13" /home/orangepi/MMDVMHost/MMDVMPLUS)
                  sed -i "3c $frec" /home/orangepi/info_panel_control.ini
master=`grep -n -m 1 "^Address=" /home/orangepi/MMDVMHost/MMDVMPLUS`
buscar=":"
...
master=$(awk "NR==$linea_master" /home/orangepi/MMDVMHost/MMDVMPLUS)
...
echo "   *           Script para Modificar MMDVMPLUS    \33[1;31m by EA3EIZ & EA4AOJ\33[1;32m     *"
echo "   **************************************************************************"
echo -n "\33[1;36m   1)\33[0m Modificar indicativo  - \33[1;33m"
ind=`grep -n -m 1 "Callsign" /home/orangepi/MMDVMHost/MMDVMPLUS`
ind1=`expr substr $ind 3 30`
echo "$ind1"

echo -n "\33[1;36m   2)\33[0m Modificar RXFrequency - \33[1;33m"
rxf=`grep -n "RXFrequency" /home/orangepi/MMDVMHost/MMDVMPLUS`
rxf1=`expr substr $rxf 4 30`
echo "$rxf1"

echo -n "\33[1;36m   3)\33[0m Modificar TXFrequency - \33[1;33m"
txf=`grep -n "TXFrequency" /home/orangepi/MMDVMHost/MMDVMPLUS`
txf1=`expr substr $txf 4 30`
echo "$txf1"

echo -n "${CIAN}   4)${GRIS} Modificar Location    - ${AMARILLO}"
loc=`grep -n "^Location=" /home/orangepi/MMDVMHost/MMDVMPLUS`
...
contenido_location=$(awk "NR==$numero_linea" /home/orangepi/MMDVMHost/MMDVMPLUS)
echo "$contenido_location"

echo -n "\33[1;36m   5)\33[0m Modificar URL         - \33[1;33m"
url=`grep -n "URL" /home/orangepi/MMDVMHost/MMDVMPLUS`
...
# Modificacion
modeport=$(awk "NR==51" /home/orangepi/MMDVMHost/MMDVMPLUS)
echo "$modeport"

echo -n "\33[1;36m  10)\33[0m Modificar ID          - \33[1;33m"
idd=`grep -n "Id=" /home/orangepi/MMDVMHost/MMDVMPLUS`
idd1=`expr substr $idd 3 30`
echo "$idd1"

#modificacion
echo -n "\33[1;36m  11)\33[0m Modificar Address     - \33[1;33m"
remoteaddress=$(awk "NR==232" /home/orangepi/MMDVMHost/MMDVMPLUS)
echo "$remoteaddress"

#modificacion
echo -n "\33[1;36m  12)\33[0m Modificar Puerto      - \33[1;33m"
remoteport=$(awk "NR==233" /home/orangepi/MMDVMHost/MMDVMPLUS)
echo "$remoteport"


pas=$(awk "NR==234" /home/orangepi/MMDVMHost/MMDVMPLUS)
...
txinv=`grep -n '\<TXInvert\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
txinv1=`expr substr $txinv 4 30`
echo -n "$txinv1"

echo -n "\33[1;36m      a)\33[0m D-STAR      - \33[1;33m"
dstar=`grep -n "\[D-Star\]" /home/orangepi/MMDVMHost/MMDVMPLUS` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valo= sed -n $numero_linea_dstar_letrap  /home/orangepi/MMDVMHost/MMDVMPLUS; #presenta el valor en pantalla

echo -n "\33[1;36m  15)\33[0m Modificar RXLevel     - \33[1;33m"
rx=`grep -n '\<RXLevel\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
rx1=`expr substr $rx 4 30`
echo -n "$rx1"

echo -n "\33[1;36m      b)\33[0m DMR         - \33[1;33m"
dmr=`grep -n "\[DMR\]" /home/orangepi/MMDVMHost/MMDVMPLUS` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valor= sed -n $numero_linea_dmr_letrap  /home/orangepi/MMDVMHost/MMDVMPLUS; #presenta el valor en pantalla

echo -n "\33[1;36m  16)\33[0m Modificar TXLevel     - \33[1;33m"
tx=`grep -n -m 1 '\<TXLevel\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
tx1=`expr substr $tx 4 30`
echo -n "$tx1"

echo -n "\33[1;36m      c)\33[0m FUSION      - \33[1;33m"
fusion=`grep -n "LowDeviation" /home/orangepi/MMDVMHost/MMDVMPLUS` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valor= sed -n $numero_linea_fusion_letrap  /home/orangepi/MMDVMHost/MMDVMPLUS; #presenta el valor en pantalla

echo -n "\33[1;36m  17)\33[0m Modificar Duplex      - \33[1;33m"
dup=`grep -n -m 1 '\<Duplex\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
dup1=`expr substr $dup 3 30`
echo -n "$dup1"


echo -n "\33[1;36m        d)\33[0m P25         - \33[1;33m"
p25=`grep -n "\[P25\]" /home/orangepi/MMDVMHost/MMDVMPLUS` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valor= sed -n $numero_linea_p25_letrap  /home/orangepi/MMDVMHost/MMDVMPLUS; #presenta el valor en pantalla

echo -n "\33[1;36m  18)\33[0m Modificar TXHang      - \33[1;33m"
txh=`grep -n -m 1 '\<TXHang\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
txh1=`expr substr $txh 5 30`
echo -n "$txh1"

echo -n "\33[1;36m        e)\33[0m Baliza      - \33[1;33m"
cw= sed -n "31p"  /home/orangepi/MMDVMHost/MMDVMPLUS; #presenta el valor en pantalla

echo -n "\33[1;36m  19)\33[0m Modificar Tramas      - \33[1;33m"
lg=`grep -n -m 1 '\<DisplayLevel\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
lg1=`expr substr $lg 4 30`
echo -n "$lg1"

echo -n "\33[1;36m  f)\33[0m RFModeHang  - \33[1;33m"
modehang=`grep -n -m 1 -c '\<RFModeHang\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
if [ $modehang = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
modehang=`grep -n -m 1 '\<RFModeHang\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
modehang1=`expr substr $modehang 3 30`
echo "$modehang1"
fi

echo -n "\33[1;36m  20)\33[0m Modificar Slot1       - \33[1;33m"
sl=`grep -n -m 1 '\<Slot1\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
sl1=`expr substr $sl 5 30`
echo -n "$sl1"

echo -n "\33[1;36m         g)\33[0m Timeout     - \33[1;33m"
timeo=`grep -n -m 1 -c '\<Timeout\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
if [ $timeo = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
timeo=`grep -n -m 1 '\<Timeout\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
timeo1=`expr substr $timeo 3 30`
echo "$timeo1"
fi

echo -n "\33[1;36m  21)\33[0m Tipo Pantalla Display - \33[1;33m"
Display=`grep -n -m 1 -c '\<Display\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
if [ $Display = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
Display=`grep -n -m 1 '\<Display\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
Display1=`expr substr $Display 3 30`
echo -n "$Display1"
fi

var=`grep -n -m 1 "\[Nextion\]" /home/orangepi/MMDVMHost/MMDVMPLUS`
#var1=`grep -m 1 "\[Nextion\]" /home/orangepi/MMDVMHost/MMDVMPLUS`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
numero_linea=`expr $numero_linea + 2` # y le suma uno qudando coomo: (75)
MODEMNEXTION=$(awk "NR==$numero_linea" /home/orangepi/MMDVMHost/MMDVMPLUS)
letra=c
...
ScreenLayout=`grep -n -m 1 -c '\<ScreenLayout\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
if [ $ScreenLayout = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
ScreenLayout=`grep -n -m 1 '\<ScreenLayout\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
ScreenLayout1=`expr substr $ScreenLayout 5 30`
echo -n "$ScreenLayout1"
fi

# i) NXDN Enable=
var=`grep -n -m 1 "\[NXDN\]" /home/orangepi/MMDVMHost/MMDVMPLUS`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
numero_linea=`expr $numero_linea + 1` # Se le suma 1 al número de linea
NXDN=$(awk "NR==$numero_linea" /home/orangepi/MMDVMHost/MMDVMPLUS)
letra=c
...
Brightness=$(awk "NR==$numero_linea" /home/orangepi/MMDVMHost/MMDVMPLUS)
letra=c
linea_sed_Brightness=$numero_linea$letra
echo -n "  ${CIAN}23) ${GRIS}Brillo Display Nextion- ${AMARILLO}$Brightness"

# j) POCSAG Enable=
var=`grep -n -m 1 "\[POCSAG\]" /home/orangepi/MMDVMHost/MMDVMPLUS`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
numero_linea=`expr $numero_linea + 1` # Se le suma 1 al número de linea
POCSAG=$(awk "NR==$numero_linea" /home/orangepi/MMDVMHost/MMDVMPLUS)
letra=c
...
lat=`grep -n "Latitude" /home/orangepi/MMDVMHost/MMDVMPLUS`
lat1=`expr substr $lat 4 30`
echo "$lat1"

# 25) Longitude=
echo -n "\33[1;36m  25)\33[0m Coordenada Longitud   - \33[1;33m"
long=`grep -n "Longitude" /home/orangepi/MMDVMHost/MMDVMPLUS`
long1=`expr substr $long 4 30`
echo "$long1"

echo -n "\33[1;36m  26)\33[0m Modulo D-STAR         - \33[1;33m"
modu=`grep -n -m 1 '\<Module\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
...
var300port= sed -n 238p  /home/orangepi/MMDVMHost/MMDVMPLUS;
...
echo ""
echo "\33[1;36m  28)\33[1;33m Abrir fichero MMDVMPLUS para hacer cualquier cambio\33[1;33m"
...
master=`grep -n -m 1 "^Address=" /home/orangepi/MMDVMHost/MMDVMPLUS_copia`
buscar=":"
largo=`expr index $master $buscar`
largo=`expr $largo + 9`
...
master=`grep -n -m 1 "^Address=" /home/orangepi/MMDVMHost/MMDVMPLUS_copia2`
buscar=":"
largo=`expr index $master $buscar`
largo=`expr $largo + 9`
...
master=`grep -n -m 1 "^Address=" /home/orangepi/MMDVMHost/MMDVMPLUS_copia3`
buscar=":"
largo=`expr index $master $buscar`
largo=`expr $largo + 9`
...
echo ""
echo "\33[1;36m  35)\33[1;31m Recuperar el fichero original MMDVMPLUS\33[1;33m"
...
indicativo=`echo "$indicativo" | tr [:lower:] [:upper:]`
                          ...
                          sed -i "$linea Callsign=$indicativo" /home/orangepi/MMDVMHost/MMDVMPLUS
...
echo "Valor actual del RXFrequency: \33[1;33m${rxf#*=}\33[1;37m"
           	          ...
           	          read -p 'Introduce RXFrequency:        ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                              sed -i "$linea RXFrequency=$var2" /home/orangepi/MMDVMHost/MMDVMPLUS
...
echo "Valor actual del TXFrequency: \33[1;33m${txf#*=}\33[1;37m"
           	          ...
           	          read -p 'Introduce TXFrequency:        ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXFrequency=$var2" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$numero_linea_letrac Location=$loc1" /home/orangepi/MMDVMHost/MMDVMPLUS
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
echo "Valor de  la  URL   Web: \33[1;33m${url#*=}\33[1;37m"
			  ...
			  ur1=`echo "$ur1" | tr -d '[[:space:]]'`
                          sed -i "$linea URL=$ur1" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "51c UARTPort=/dev/ttyS3" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "51c UARTPort=/dev/ttyACM0" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "51c UARTPort=/dev/ttyACM1" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "51c UARTPort=/dev/ttyUSB0" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del Id: \33[1;33m${idd#*=}\33[1;37m"
           	          read -p 'Introduce un ID válido ' miid
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Id=$miid" /home/orangepi/MMDVMHost/MMDVMPLUS
...
do
                        ...
                        case $actualizar in
                        [sS]* ) echo ""
                        sed -i "232c RemoteAddress=$remoteaddress" /home/orangepi/MMDVMHost/MMDVMPLUS
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do
                        ...
                        case $actualizar in
                        [sS]* ) echo ""
                        sed -i "233c RemotePort=$remoteport" /home/orangepi/MMDVMHost/MMDVMPLUS
        break;;
        [nN]* ) echo ""
        break;;
esac
...
do
           	          ...
           	          read -p '   Introduce el password que corresponda: ' pas1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "234c Password=$pas1" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual del  TXInvert: \33[1;33m${txinv#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXInvert=$txinv1" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  RXLevel : \33[1;33m${rx#*=}\33[1;37m"
           	          read -p 'Valor óptimo para DVMEGA=45 : ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea RXLevel=$var2" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  TXLevel : \33[1;33m${tx#*=}\33[1;37m"
           	          read -p 'Valor óptimo para DVMEGA=50 : ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXLevel=$var2" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Duplex: \33[1;33m${dup#*=}\33[1;37m"
           	          read -p 'Para un repetidor Duplex=1 Para un DVMEGA Duplex=0: ' dup1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Duplex=$dup1" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del TXHang: \33[1;33m${txh#*=}\33[1;37m"
           	          read -p 'Para un repetidor TXHang=4 Para un DVMEGA TXHang=0: ' txh1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXHang=$txh1" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del DisplayLevel: \33[1;33m${lg#*=}\33[1;37m"
           	     read -p 'Para visualizar tramas seguidas introduce 1, para una sola trama introduce 2:' lg1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea DisplayLevel=$lg1" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
while true
do
sl=`grep -n -m 1 -c '\<Slot1\>' /home/orangepi/MMDVMHost/MMDVMPLUS`
if [ $sl = 0 ]; then
...
echo "Valor actual del Slot1=: \33[1;33m${sl#*=}\33[1;37m"
           	          read -p 'Para DVMEGA Modificar el valor del Slot1=0: ' V
			              ...
			              [sS]* ) echo ""
			              V=`echo "$V" | tr -d '[[:space:]]'`			  
                          sed -i "$linea Slot1=$V" /home/orangepi/MMDVMHost/MMDVMPLUS             
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Display=: \33[1;33m${Display1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea Display=$V" /home/orangepi/MMDVMHost/MMDVMPLUS             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor actual del ScreenLayout=: \33[1;33m${ScreenLayout1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea ScreenLayout=$V" /home/orangepi/MMDVMHost/MMDVMPLUS             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
do
                          ...
                          [sS]* ) echo ""
                          V=`echo "$V" | tr -d '[[:space:]]'`      
                          sed -i "$linea_sed_Brightness Brightness=$V" /home/orangepi/MMDVMHost/MMDVMPLUS             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
modu1=`echo "$modu1" | tr [:lower:] [:upper:]`
                          ...
                          sed -i "$linea Module=$modu1" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_dstar_letrap  /home/orangepi/MMDVMHost/MMDVMPLUS;
                          read -p 'Desactivado=0 Activado=1:  '   dmrac1
                          actualizar=S 
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$numero_linea_dstar_letrac Enable=$dmrac1" /home/orangepi/MMDVMHost/MMDVMPLUS
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_dmr_letrap  /home/orangepi/MMDVMHost/MMDVMPLUS;
           	              read -p 'Desactivado=0 Activado=1: '   dmrac1
                          actualizar=S 
                          case $actualizar in
			                    [sS]* ) echo ""
                          sed -i "$numero_linea_dmr_letrac Enable=$dmrac1" /home/orangepi/MMDVMHost/MMDVMPLUS
			                    break;;
			                    [nN]* ) echo ""
			                    break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_fusion_letrap  /home/orangepi/MMDVMHost/MMDVMPLUS;
                          read -p 'Desactivado=0 Activado=1:  '   dmrac1
                          actualizar=S 
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$numero_linea_fusion_letrac Enable=$dmrac1" /home/orangepi/MMDVMHost/MMDVMPLUS
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_p25_letrap  /home/orangepi/MMDVMHost/MMDVMPLUS;
                          read -p 'Desactivado=0 Activado=1: '   dmrac1
                          actualizar=S 
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$numero_linea_p25_letrac Enable=$dmrac1" /home/orangepi/MMDVMHost/MMDVMPLUS
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                      ...
                      case $actualizar in
                      [sS]* ) echo ""
                      sed -i "31c Enable=$baliza" /home/orangepi/MMDVMHost/MMDVMPLUS
                      break;;
                      [nN]* ) echo ""
                      break;;
esac
...
echo "Valor actual del RFModeHang = : \33[1;33m${modehang1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea RFModeHang=$V" /home/orangepi/MMDVMHost/MMDVMPLUS             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor actual del Timeout = : \33[1;33m${timeo1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea Timeout=$V" /home/orangepi/MMDVMHost/MMDVMPLUS             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor del Port: \33[1;33m$MODEMNEXTION"
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_MN Port=$lat1" /home/orangepi/MMDVMHost/MMDVMPLUS
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
echo "Valor actual NXDN: \33[1;33m$NXDN"
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_NXDN Enable=$NXDN1" /home/orangepi/MMDVMHost/MMDVMPLUS
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_POCSAG Enable=$POCSAG1" /home/orangepi/MMDVMHost/MMDVMPLUS
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
echo "Valor de la Latitud: \33[1;33m${lat#*=}\33[1;37m"
           	          read -p 'Introduce la Latitud ' lat1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Latitude=$lat1" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de la Longitud: \33[1;33m${long#*=}\33[1;37m"
           	          read -p 'Introduce la Longitud ' long1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Longitude=$long1" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  read -p 'Intruduce reflector DMR+ al que se conectara (ej:4374) ' opcion
                          sed -i "238c Options=StartRef=$opcion;RelinkTime=10;" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
			  [nN]* ) echo ""
			  sed -i "238c #Options=StartRef=4370;RelinkTime=10;" /home/orangepi/MMDVMHost/MMDVMPLUS
			  break;;
esac
done;;
28) echo ""
...
do
                              ...
                              case $actualizar in
			                        [sS]* ) echo ""
                              sudo geany /home/orangepi/MMDVMHost/MMDVMPLUS
			                        break;;
			                        [nN]* ) echo ""
			                        break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/orangepi/MMDVMHost/MMDVMPLUS /home/orangepi/MMDVMHost/MMDVMPLUS_copia
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/orangepi/MMDVMHost/MMDVMPLUS_copia /home/orangepi/MMDVMHost/MMDVMPLUS
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/orangepi/MMDVMHost/MMDVMPLUS /home/orangepi/MMDVMHost/MMDVMPLUS_copia2
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/orangepi/MMDVMHost/MMDVMPLUS_copia2 /home/orangepi/MMDVMHost/MMDVMPLUS
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/orangepi/MMDVMHost/MMDVMPLUS /home/orangepi/MMDVMHost/MMDVMPLUS_copia3
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
do
                        ...
                        sleep 3
                        sudo cp -f /home/orangepi/MMDVMHost/MMDVMPLUS_copia3 /home/orangepi/MMDVMHost/MMDVMPLUS
			                  break;;
			                  [nN]* ) echo ""
			                  break;;
esac
...
do
           	        ...
           	        read -p 'Quieres restaurar el fichero original MMDVMPLUS? S/N ' restaurar1   
                        case $restaurar1 in
			[sS]* ) echo ""
                        clear
                        echo "<<<<<< Restaurando el fichero original MMDVMPLUS >>>>>"
                        sleep 3
                        sudo cp -f /home/orangepi/MMDVMHost/MMDVM.ini_original /home/orangepi/MMDVMHost/MMDVMPLUS
			break;;
			[nN]* ) echo ""
			break;;
esac
