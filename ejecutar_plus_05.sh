...
xterm -geometry 86x13+24+830 -bg black -fg green -fa 'roboto' -fs 9x -T DMR+ -e sudo ./MMDVMPLUS MMDVMPLUS.ini

sed -i "6c Exec=xterm -geometry 86x13+24+830 -bg black -fg green -fa 'roboto' -fs 9x -T DMR+ -e sh ejecutar_plus_05.sh" /home/orangepi/Desktop/DMRPLUS.desktop
