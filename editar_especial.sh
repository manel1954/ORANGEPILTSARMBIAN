...
# Modificacion
modeport=$(awk "NR==51" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini)
echo "$modeport"
...
remoteaddress=$(awk "NR==232" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini)
echo "$remoteaddress"

#modificacion
echo -n "\33[1;36m  12)\33[0m Modificar Puerto      - \33[1;33m"
remoteport=$(awk "NR==233" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini)
echo "$remoteport"
...
echo ""
echo "\33[1;36m  28)\33[1;33m Abrir fichero MMDVMESPECIAL.ini para hacer cualquier cambio\33[1;33m"
...
do
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "51c UARTPort=/dev/ttyS3" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "51c UARTPort=/dev/ttyACM0" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "51c UARTPort=/dev/ttyACM1" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "51c UARTPort=/dev/ttyUSB0" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                        ...
                        case $actualizar in
                        [sS]* ) echo ""
                        sed -i "232c RemoteAddress=$remoteaddress" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
                        break;;
                        [nN]* ) echo ""
                        break;;
esac
...
do
                        ...
                        case $actualizar in
                        [sS]* ) echo ""
                        sed -i "233c RemotePort=$remoteport" /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
        break;;
        [nN]* ) echo ""
        break;;
esac
...
do
                              ...
                              case $actualizar in
			                        [sS]* ) echo ""
                              sudo geany /home/orangepi/MMDVMHost/MMDVMESPECIAL.ini
			                        break;;
			                        [nN]* ) echo ""
			                        break;;
esac
