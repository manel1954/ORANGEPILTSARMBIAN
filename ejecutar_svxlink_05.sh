...
# sudo svxlink
xterm -geometry 69x29+22+48 -bg blue -fg white -fa ‘verdana’ -fs 9x -T SVXLINK -e sudo svxlink

sed -i "6c Exec=xterm -geometry 69x29+22+48 -bg blue -fg white -fa ‘verdana’ -fs 9x -T SVXLINK -e sh ejecutar_svxlink_05.sh" /home/orangepi/Desktop/Abrir_SVXLink.desktop
